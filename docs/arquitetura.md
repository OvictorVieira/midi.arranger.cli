...
**Quatro achados do motor**, todos com repro concreto. Os de número 1 (issue #125) e 3 (issue #124)
foram corrigidos e hoje são teste de regressão comum; os de número 2 e 4 seguem com
`xfail(strict=True)` no arquivo, e cada marcador quebra o build no dia em que o defeito sair:
